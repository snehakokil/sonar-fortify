...
public class FortifyReportOverview {
	private static final String TITLE = FortifyReportElement.REPORT_OVERVIEW.getContent();
	private final String summary_title, summary_desc, summary_text;
	private final String issues_title, issues_desc;
	private final Map<String, Integer> issue_counts;
	
	private FortifyReportOverview(String summary_title, String summary_desc, String summary_text,
			String issues_title, String issues_desc, Map<String, Integer> issue_counts) {
		this.summary_title = summary_title;
		this.summary_desc = summary_desc;
		this.summary_text = summary_text;
		this.issues_title = issues_title;
		this.issues_desc = issues_desc;
	...
	public static FortifyReportOverview parseReportOverview(SMHierarchicCursor cursor) throws XMLStreamException, FortifyXMLParseException {
		...
		return new FortifyReportOverview(sum_title, sum_desc, sum_txt, iss_title, iss_desc, iss_counts);
	}
}
